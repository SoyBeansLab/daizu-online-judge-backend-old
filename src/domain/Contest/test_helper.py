...
def create_recent_contests(n: int) -> List[Contest]:
    ...
    for i in range(n):
        result.append(Contest(
            ...
            contest_finish_date=create_recent_test_datetime() + timedelta(days=1),
            contest_time=120,
            writer="ucpr",
            description="Welcome",
            top_content="Welcome",
...
def create_upcoming_contests(n: int) -> List[Contest]:
    ...
    for i in range(n):
        result.append(Contest(
            ...
            contest_finish_date=create_upcoming_test_datetime() + timedelta(days=1),
            contest_time=120,
            writer="ucpr",
            description="Welcome",
            top_content="Welcome",
...
def create_current_contests(n: int) -> List[Contest]:
    ...
    for i in range(n):
        result.append(Contest(
            ...
            contest_finish_date=create_current_test_datetime() + timedelta(days=1),
            contest_time=120,
            writer="ucpr",
            description="Welcome",
            top_content="Welcome",
